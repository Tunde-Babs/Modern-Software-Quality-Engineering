...
[Findings §8](FIRST_EDITION_FINDINGS.md#8-learning-ready-fast-track-execution-overlay) is the canonical current allocation of the 20 outstanding findings. It overlays the historical H4–H7 architecture without deleting its provenance, closure criteria or specialist controls. H1/H2/H3 remain independently verified and closed. H4–H7 and all fast-track remediation packages remain not started.
