...
- **Next boundary:** v0.14.0 — System Design & Architecture Complete remains planned and unreleased. Part XI — System Design & Architecture has completed its manuscript and Final Quality Gate; its release administration is separate from Part X's completed v0.13.0 lifecycle.
