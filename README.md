...
| **v0.5.0** | 🚧 Release preparation | Programming Complete |
| **v1.0.0** | 🎯 Planned | First Edition |

## Current Focus

- Part II – Programming for Quality Engineers release preparation
- Companion learning resources and release-validation evidence
...
| Latest Release | **v0.4.0 – Foundations Complete** |
| Current Release Target | **v0.5.0 – Programming Complete (release preparation)** |
