...
Part XI — System Design & Architecture is **released as v0.14.0** and its release lifecycle is complete. The Final Part XI Quality Gate remains **96/100 (verdict A)**; P0/P1/P2 findings are none and six residual P3 items remain non-blocking. Controlled manuscript baseline `7067ebb54cba199a9215363188171d2e4966ed15` is preserved and Chapters 1–12 remain `Status: Draft`. **v0.14.0 is the latest stable release.** Part XII — Engineering Leadership & Career Growth is the next planned handbook part and **has not started**.
...
- Begin a separate Part XII curriculum-architecture planning task. Do not start Part XII manuscript drafting, Part XI Pass 2 assets, or v0.15.0 release administration without separate authorization.
